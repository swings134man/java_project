...
public class HomeController {
	...
	public void insert(MemberDTO dto) {
		...
		//DAO 처리 해줄 예정...
		//서버가 결과를 알려주기 위한 페이지가 필요! 
	}
	
	@RequestMapping("check.mega")
	public void checkId(MemberDTO dto) {
		System.out.println("컨트롤러 메서드 호출됨.....");
		System.out.println("입력한 id : " + dto.getId());
		System.out.println("입력한 pw : " + dto.getPw());
		// 컨트롤러에서 처리를 한 후, 클라이언트에게 결과를 알려주어야 한다. 
		// views 아래에 check.jsp 로 만듬 
	}
