...
//						JOptionPane.showMessageDialog(f, "예약 성공");
		...
		re1.setBackground(Color.ORANGE);
		re1.setOpaque(true);
		re1.setBounds(88, 113, 289, 184);
		f.getContentPane().add(re1);
		
		JLabel re2 = new JLabel("제목제목");
		re2.setBackground(Color.ORANGE);
		re2.setOpaque(true);
		re2.setBounds(404, 113, 615, 48);
		f.getContentPane().add(re2);
		
		JLabel re3 = new JLabel("설명설명설명설명");
		re3.setBackground(Color.ORANGE);
		re3.setOpaque(true);
		re3.setBounds(404, 173, 615, 124);
